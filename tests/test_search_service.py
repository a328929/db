...
from tg_harvest.search.service import _format_data_version
from tg_harvest.search.service import _make_count_cache_key
from tg_harvest.search.service import _read_database_fingerprint
...
class SearchServiceFastCountTests(unittest.TestCase):
    ...
    def test_search_payload_service_schedules_async_maintenance_instead_of_draining_inline(
        ...
        with patch(
            "tg_harvest.search.service.schedule_message_search_maintenance"
        ) as schedule_mock, patch(
            "tg_harvest.search.service.drain_message_search_terms_rebuild_queue",
    ...
    def test_file_database_fingerprint_ignores_connection_local_data_version(self) -> None:
        ...
        try:
            ...
            with patch(
                "tg_harvest.search.service._read_data_version",
                side_effect=[101, 202],
            ):
